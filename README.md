# Python - Physics - Destructive Sound Inteference
This project was created as a part of a Physics presentation in which we use the different python scripts to exemplify how a destructive sound inteference works.\
